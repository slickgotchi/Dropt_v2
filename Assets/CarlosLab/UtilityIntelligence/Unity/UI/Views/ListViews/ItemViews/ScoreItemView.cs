...
{
    public class ScoreItemView<TItemViewModel> : BaseNameItemView<TItemViewModel>
        where TItemViewModel : class, IItemViewModel
    {
        private float score;

        public ScoreItemView(IListViewWithItem<TItemViewModel> listView) : base(false, listView)
        {
