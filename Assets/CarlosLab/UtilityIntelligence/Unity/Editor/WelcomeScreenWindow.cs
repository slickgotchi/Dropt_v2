    ...
    public class WelcomeScreenWindow : BaseEditorWindow
    {
        public static void StartUp()
        {
            if (FrameworkEditorPrefs.FrameworkVersion != FrameworkRuntimeConsts.FrameworkVersion)
            {
                ...
                FrameworkEditorPrefs.HideWelcomeScreen = false;
            }

            if (FrameworkEditorPrefs.HideWelcomeScreen)
                return;
        ...
        protected override void OnInitGUI()
        {
            ...
            dontShowAgainToggle.value = FrameworkEditorPrefs.HideWelcomeScreen;
            dontShowAgainToggle.RegisterValueChangedCallback(evt => FrameworkEditorPrefs.HideWelcomeScreen = evt.newValue);
        }
    }
}