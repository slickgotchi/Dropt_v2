...
public class BallisticSnipe : PlayerAbility
{
    ...
    void ActivateProjectile(Wearable.NameEnum activationWearable, Vector3 direction, float distance, float duration, float scale)
    {
    ...
    void ActivateProjectileClientRpc(Wearable.NameEnum activationWearable, Vector3 startPosition, Vector3 direction, float distance, float duration, float scale)
    {
        GameObject projectile = GetProjectileInstance(activationWearable);
